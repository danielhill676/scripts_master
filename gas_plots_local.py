...
def plot_llama_property(x_column: str, y_column: str, AGN_data, inactive_data, agn_bol, inactive_bol, GB21, wis, sim, phangs, use_gb21=False, soloplot=None, exclude_names=None, logx=False, logy=False,
    ...
    if compare and comb_llama and not use_phangs and not use_sim and not use_wis and not use_gb21:
        ...
        output_path = f'/Users/administrator/Astro/LLAMA/ALMA/gas_distribution_fits/Plots/compare_{x_column}_vs_{y_column}.png'
...
###################### end of comparison block ##########################
    if not compare:
        ...
        if x_column == 'log L′ CO':
            ...
            print(merged_AGN_clean['Name_clean'], merged_AGN_clean['Telescope'])
...
for mask in masks:
    ...
    ############ CAS with stellar mass #############
        ...
        # plot_llama_property('log LX','Concentration',AGN_data, inactive_data, agn_Rosario2018, inactive_Rosario2018,GB24,wisdom, simulations, phangs,use_gb21=True,mask=mask,R_kpc=R_kpc,exclude_names=['NGC 1375','NGC 1315','NGC 2775','NGC 4260'])
        ...
        # plot_llama_property('clumping_factor', 'Concentration', AGN_data, inactive_data, agn_Rosario2018, inactive_Rosario2018,GB24,wisdom, simulations, phangs,False,mask=mask,R_kpc=R_kpc,exclude_names=['NGC 1375','NGC 1315','NGC 2775','NGC 4260', 'NGC 5845'])
